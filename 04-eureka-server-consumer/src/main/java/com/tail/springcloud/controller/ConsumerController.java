...
public class ConsumerController {
    ...
    public Object test(){
         ...
         *
         *       根据url的服务名称，到注册中心寻找服务，找到服务IP和端口号，
         *       由springcloud根据获取的服务清单去访问具体的服务
         *
         *       使用注册中心访问服务，RestTemplate必须支持Ribbon的负载均衡才能访问
         *       一个服务名可能部署了多个服务，才能访问具体的服务。
         *       当获取了清单列表，由Ribbon完成负载均衡访问，Ribbon的配置才考RestTemplateConfig
         *
         */

        String url="http://02-EUREKA-CLIENT/test";
